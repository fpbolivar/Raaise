...
public class ShowOtherUserVideoActivity extends AppCompatActivity implements ViewPublicUserVideoAdapter.HomeReelsListener,
    ...
    public void ShowCommentBottomSheetDialog(String VideoId, TextView textView) {
        ...
        adapter = new CommentsAdapter(ShowOtherUserVideoActivity.this, comments, ShowOtherUserVideoActivity.this, ShowOtherUserVideoActivity.this);
    ...
    private void hitCommentReplyEditApi(String replyID, String reply) {
        ...
        apiManager.editCommentReply(Prefs.GetBearerToken(ShowOtherUserVideoActivity.this), model, new DataCallback<VideoCommentDelete>() {
            @Override
            ...
            public void onError(ServerError serverError) {
                Toast.makeText(ShowOtherUserVideoActivity.this, serverError.getErrorMsg(), Toast.LENGTH_SHORT).show();
                Dialogs.HideProgressDialog();
            }
        });
    }
    ...
    private void hitEditVdoCommentApi(String edit_comment_id, String comment) {
        ...
        apiManager.editVideoComment(Prefs.GetBearerToken(ShowOtherUserVideoActivity.this), pojo, new DataCallback<VideoCommentDelete>() {
            @Override
            public void onSuccess(VideoCommentDelete videoCommentDelete) {
                EDITING_COMMENT = false;
                EditTextInCommentsBottomDialog.setText("");
    ...
    private void openMoreOptionsDialog(List<PublicUserVideoListModel.Data> list, int position, boolean isReported) {
        ...
        blockVideoBtn.setOnClickListener(view -> {
            ...
            apiManager.blockVideo(Prefs.GetBearerToken(ShowOtherUserVideoActivity.this), model, new DataCallback<VideoCommentDelete>() {
                @Override
                public void onSuccess(VideoCommentDelete videoCommentDelete) {
                    Dialogs.HideProgressDialog();
                    Toast.makeText(ShowOtherUserVideoActivity.this, videoCommentDelete.message, Toast.LENGTH_SHORT).show();
                }
    ...
    @Override
    public void ShowDonationDialog(String UserId, String VideoId, PublicUserVideoListModel.Data obj) {
    ...
    private void deleteVdoComment(String videoID, String commentID, Dialog dialog) {
        ...
        apiManager.deleteVideoComment(Prefs.GetBearerToken(ShowOtherUserVideoActivity.this), pojo, new DataCallback<VideoCommentDelete>() {
            @Override
            public void onSuccess(VideoCommentDelete videoCommentDelete) {
                Dialogs.HideProgressDialog();
                Toast.makeText(ShowOtherUserVideoActivity.this, videoCommentDelete.message, Toast.LENGTH_SHORT).show();
    ...
    private void deleteCommentReply(String id) {
        ...
        Dialogs.createProgressDialog(ShowOtherUserVideoActivity.this);
        apiManager.deleteCommentReply(Prefs.GetBearerToken(ShowOtherUserVideoActivity.this), model, new DataCallback<VideoCommentDelete>() {
            @Override
            public void onSuccess(VideoCommentDelete videoCommentDelete) {
                hitCommentApi();
                Dialogs.HideProgressDialog();
    ...
    private void beginDownload(String audioLink) {
        try {
            Dialogs.createProgressDialog(ShowOtherUserVideoActivity.this);
            DownloadManager.Request downloadRequest = new DownloadManager.Request(Uri.parse(Prefs.GetBaseUrl(ShowOtherUserVideoActivity.this) + audioLink));
            ...
            Dialogs.HideProgressDialog();
            Toast.makeText(ShowOtherUserVideoActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
}