...
public class TryAudioAllVideosRells extends RecyclerView.Adapter<TryAudioAllVideosRells.ViewHolder> {
    Context context;
    ...
    public TryAudioAllVideosRells(Context context, List<GetVideosBasedOnAudioIdModel.Videos> list, HomeReelsListener homeReelsListener) {
    ...
    @NonNull
    @Override
    public TryAudioAllVideosRells.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TryAudioAllVideosRells.ViewHolder(LayoutInflater.from(context).inflate(R.layout.home_videos_single_item, parent, false));

    }

    @Override
    public void onBindViewHolder(@NonNull TryAudioAllVideosRells.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.FollowButtonInHomeVideoSingleItem.setOnClickListener(view -> {
            ...
            if (obj.isFollow()) {
                obj.setFollow(false);
                HelperClass.ChangeFollowUnFollowAudio(list, obj.getUserId().getUserName(), false);
                holder.FollowTextInHomeVideoSingleItem.setText("Follow");
            } else {
                obj.setFollow(true);
                HelperClass.ChangeFollowUnFollowAudio(list, obj.getUserId().getUserName(), true);
        ...
        holder.ShareVideo.setOnClickListener(view -> homeReelsListener.ShowShareVideoDialog(obj.getVideoLink()));
        if (obj.isDonation) {
    ...
    public interface HomeReelsListener {
        ...
        void ShowShareVideoDialog(String videoLink);
