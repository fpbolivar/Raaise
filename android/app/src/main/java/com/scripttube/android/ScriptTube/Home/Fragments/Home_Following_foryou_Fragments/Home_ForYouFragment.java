...
public class Home_ForYouFragment extends Fragment implements HomeFollowingAdapter.HomeReelsListener, CommentsAdapter.CommentReplyListener {
...
//                Log.i("Redninam", "TEST        position     " + position);
//                Log.i("Redninam", "TEST        positionOffset     " + positionOffset);
//                Log.i("Redninam", "TEST        positionOffsetPixels     " + positionOffsetPixels);
//                if (position == list.size() - 2) {
////                    Log.i("Redninam", "TEST        position     " + position);
//                    HitGlobalVideoApi("10", String.valueOf(PageCounter));
//                    PageCounter++;
//
//                }
    ...
    void HitGlobalVideoApi(String limit, String page) {
        ...
        apiManager.GetGlobalVideo(Prefs.GetBearerToken(App.getContext()), model, new DataCallback<GetGlobalVideoModel>() {
            ...
            public void onSuccess(GetGlobalVideoModel getGlobalVideoModel) {
                Log.e("SizeOfApi ", "onSuccess: "+getGlobalVideoModel.getData().size() );
