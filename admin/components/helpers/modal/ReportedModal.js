...
class ReportedModal extends React.Component {
  ...
  //getReportedVideo() function is called
  componentDidMount =()=>{
    document.getElementById("custom-loader").style.display = "block";
    this.getReportedVideo()
  }

  //API calling in this function to get Reported Videos in the table. 
    ...
    return (
      <Modal>
        <ModalContent width="60%" height="550px">
          ...
          <video controls autoPlay style={{objectFit: "cover",width: "100%",height: "300px",}}>
