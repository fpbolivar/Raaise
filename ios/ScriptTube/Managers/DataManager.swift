...
class DataManager{
    ...
    class func getUserFollowes(delegate:UIViewController,isForFollowing:Bool,param:[String:String],onError:@escaping(String)->Void,completion:@escaping(JSON)->Void){
        delegate.pleaseWait()
