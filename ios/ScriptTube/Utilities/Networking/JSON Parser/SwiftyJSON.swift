...
public enum IndexJSON<T: Any>: Comparable {
    case array(Int)
    case dictionary(DictionaryIndex<String, T>)
    case null

    static public func == (lhs: IndexJSON, rhs: IndexJSON) -> Bool {
        switch (lhs, rhs) {
...
public typealias JSONIndex = IndexJSON<JSON>
public typealias JSONRawIndex = IndexJSON<Any>
