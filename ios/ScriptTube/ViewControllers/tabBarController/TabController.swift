...
//        self.edgesForExtendedLayout = .bottom
        ...
        discoverViewController = SearchVC()//UINavigationController(rootViewController:SearchVC())
        mediaViewController = AddMediaVC()
        inboxViewController = InboxVC() //UINavigationController(rootViewController:InboxVC())
        profileViewController = ProfileVC()// UINavigationController(rootViewController:ProfileVC())
